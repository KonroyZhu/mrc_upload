...
class QA_Self(nn.Module):  # param: 16821760
    def __init__(self, options, embedding=None):
        super(QA_Self, self).__init__()
    ...
    def forward(self, inputs,shuffle=True):
        ...
        a_embedding = self.a_self(a_embedding.transpose(1,2)).transpose(1,2)      # self emb
