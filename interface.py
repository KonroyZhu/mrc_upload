...
def get_pkl(md_list, dt_name, opts, get_argmax=True):
    ...
    for model_name in md_list:
        ...
        if torch.cuda.is_available():
            model.cuda()
        inference(model, data, model_name, dt_name, opts, get_argmax)
...
if __name__ == '__main__':
    ...
    md_list = ["mw_f_ori","mwan_fd0.5"]
    get_pkl(md_list, dt_name, opts, get_argmax=True)
